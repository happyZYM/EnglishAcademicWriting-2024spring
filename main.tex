...
\begin{abstract}
%This paper explores the integration of Generative AI (GenAI) in personalized learning for computer science (CS) education. Drawing on various studies, we investigate the roles and impacts of GenAI on coding tasks and overall student engagement. Our methodology includes survey design, data collection, and quantitative analysis on students' AI knowledge, usage, trust levels, and perceptions toward GenAI-assisted learning. Findings indicate that CS students benefit significantly from leveraging GenAI for coding assistance, yet reveal areas requiring improvement, such as data security and trust. Though the study is limited by sample size and duration, it suggests promising directions for future research on enhancing GenAI tools' efficacy and acceptance in CS education.
% This study explores the role of generative AI in assisting the personalized learning of computer science (CS) students. Through a survey of approximately 100 CS students, we investigate their knowledge, usage, trust, and perceptions of AI tools in coding and learning tasks. The results indicate that CS students have a relatively high level of understanding about AI and frequently utilize AI for coding assistance. They exhibit a moderate to high degree of trust in AI's capabilities, with the recognition of its current limitations. Quantitative analysis reveals a positive correlation between the perceived effectiveness of AI and the level of trust placed in it by CS students. Based on these findings, we discuss strategies for guiding CS students to effectively leverage AI for personalized learning, considering their unique characteristics and needs. We also highlight the potential for CS students to contribute back to the development of generative AI systems. While the study provides valuable insights, the limited sample size and lack of long-term tracking of AI's impact on student learning are noted as limitations. Overall, this research contributes to the understanding of CS students' perspectives on generative AI and offers recommendations for its effective integration into their personalized learning journeys.
Generative Artificial Intelligence (GenAI) systems have experienced rapid growth in recent years, significantly impacting the field of education by offering capabilities such as paper writing, code generation, and concept explanation. Computer science (CS) students are at the forefront of adopting and benefiting from AI technologies, making it crucial to understand how GenAI can specifically support CS education. This study explores the role of GenAI in assisting the personalized learning of CS students. By surveying 101 CS students from Shanghai Jiao Tong University (SJTU), we investigated their knowledge, usage, trust, and perceptions of AI tools in coding and learning tasks. Our results revealed diverse usage patterns and varying levels of trust in GenAI among students. Based on these findings, we discussed strategies to guide CS students in effectively leveraging AI for personalized learning, considering their unique characteristics and needs. Overall, this research contributes to understanding CS students' perspectives on GenAI and offers recommendations for its effective integration into their personalized learning journeys.
\end{abstract}
...
\paragraph{}
As we have discussed, The complex knowledge system is the feature of CS. While the traditional search engine is inefficient in front of the scattered knowledge, AI could efficiently retrieval and filtering. In fact, Expanding one's knowledge and providing learning resources is a common direction many students pursue when using AI.(49.5 percentages and 47.52 percentages). Therefore, CS students should leverage AI's concise search ability to find the most suitable learning materials and courses based on their individual needs and progress. AI recommendation  can provide customized learning paths tailored to students' learning history and interests.
\paragraph{}
Additionally, CS often need the creative solutions to a specific problem, which is the weakness of traditional search engine. But students can ask to AI for some constructive suggestion, getting the inspire from the answer. Students can also ask AI about the motivations behind certain actions and delve deeper into areas they do not understand, achieving in-depth and targeted learning.
